<?php
	...
	class TBGSeverity extends TBGDatatype 
	{
		...
		protected $_itemtype = \thebuggenie\entities\Datatype::SEVERITY;
		...
		public static function getAll()
		{
			if (self::$_items === NULL)
			{
				...
				if ($items = TBGListTypesTable::getTable()->getAllByItemType(self::SEVERITY))
				{
					...
					{
						self::$_items[$row_id] = \caspar\core\Caspar::factory()->TBGSeverity($row_id, $row);
					}
				}
			}
			return self::$_items;
		...
		public static function createNew($name)
		{
			...
			return \caspar\core\Caspar::factory()->TBGSeverity($res->getInsertID());
		}
