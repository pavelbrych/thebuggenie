<?php
	...
	class TBGResolution extends TBGDatatype 
	{
		...
		public static function getAll()
		{
			if (self::$_items === NULL)
			{
				...
				if ($items = TBGListTypesTable::getTable()->getAllByItemType(self::RESOLUTION))
				{
					...
					{
						self::$_items[$row_id] = \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\Resolution', $row_id, $row);
					}
				}
			}
			return self::$_items;
		...
		public static function createNew($name)
		{
			...
			return \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\Resolution', $res->getInsertID());
		}
