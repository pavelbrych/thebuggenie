<?php
	 ...
	 * @subpackage core
	 */
	class WorkflowScheme extends \thebuggenie\core\IdentifiableClass
	{

		static protected $_b2dbtablename = '\\thebuggenie\\tables\\WorkflowSchemes';
		...
		public function isInUse()
		{
			...
			{
				$this->_number_of_projects = \caspar\core\Caspar::getB2DBInstance()->getTable('\\thebuggenie\\tables\\Projects')->countByWorkflowSchemeID($this->getID());
			}
