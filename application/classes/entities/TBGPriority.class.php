<?php
	...
	class TBGPriority extends TBGDatatype 
	{
		...
		public static function getAll()
		{
			if (self::$_items === NULL)
			{
				...
				if ($items = TBGListTypesTable::getTable()->getAllByItemType(self::PRIORITY))
				{
					...
					{
						self::$_items[$row_id] = \caspar\core\Caspar::factory()->manufacture('TBGPriority', $row_id, $row);
					}
				}
			}
			return self::$_items;
		...
		public static function createNew($name)
		{
			...
			return \caspar\core\Caspar::factory()->manufacture('TBGPriority', $res->getInsertID());
		}
