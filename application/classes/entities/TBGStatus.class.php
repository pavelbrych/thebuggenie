<?php
	...
	class TBGStatus extends TBGDatatype 
	{
		...
		public static function getAll()
		{
			if (self::$_items === null)
			{
				...
				if ($items = TBGListTypesTable::getTable()->getAllByItemType(self::STATUS))
				{
					...
					{
						self::$_items[$row_id] = \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\Status', $row_id, $row);
					}
				}
			}
			return self::$_items;
		...
		public static function createNew($name, $itemdata = null)
		{
			...
			return \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\Status', $res->getInsertID());
		}
