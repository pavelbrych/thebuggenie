<?php
	...
	class Issues extends ScopedTable 
	{
		...
		protected function _setup()
		{
			...
			parent::_addForeignKeyColumn(self::POSTED_BY, $this->_connection->getTable('\\thebuggenie\\tables\Users'), Users::ID);
			parent::_addForeignKeyColumn(self::RESOLUTION, $this->_connection->getTable('\\thebuggenie\\tables\\ListTypes'), ListTypes::ID);
			parent::_addForeignKeyColumn(self::ISSUE_TYPE, $this->_connection->getTable('\\thebuggenie\\tables\\IssueTypes'), IssueTypes::ID);
			parent::_addForeignKeyColumn(self::STATUS, $this->_connection->getTable('\\thebuggenie\\tables\\ListTypes'), ListTypes::ID);
			parent::_addForeignKeyColumn(self::PRIORITY, $this->_connection->getTable('\\thebuggenie\\tables\\ListTypes'), ListTypes::ID);
			parent::_addForeignKeyColumn(self::CATEGORY, $this->_connection->getTable('\\thebuggenie\\tables\\ListTypes'), ListTypes::ID);
			parent::_addForeignKeyColumn(self::SEVERITY, $this->_connection->getTable('\\thebuggenie\\tables\\ListTypes'), ListTypes::ID);
			parent::_addForeignKeyColumn(self::REPRODUCABILITY, $this->_connection->getTable('\\thebuggenie\\tables\\ListTypes'), ListTypes::ID);
			parent::_addForeignKeyColumn(self::BEING_WORKED_ON_BY_USER, $this->_connection->getTable('\\thebuggenie\\tables\Users'), Users::ID);
			parent::_addForeignKeyColumn(self::MILESTONE, $this->_connection->getTable('\\thebuggenie\\tables\\Milestones'), Milestones::ID);
			parent::_addForeignKeyColumn(self::WORKFLOW_STEP_ID, $this->_connection->getTable('\\thebuggenie\\tables\\WorkflowSteps'), WorkflowSteps::ID);
		...
		public function getCountsByProjectIDandMilestone($project_id, $milestone_id, $exclude_tasks = false)
		{
			...
			if ($exclude_tasks)
			{
				$crit->addJoin($this->_connection->getTable('\\thebuggenie\\tables\\IssueTypes'), IssueTypes::ID, self::ISSUE_TYPE);
				$crit->addWhere(IssueTypes::TASK, false);
			}
		...
		public function getRecentByProjectIDandIssueType($project_id, $issuetypes, $limit = 5)
		{
			...
			$crit->addJoin($this->_connection->getTable('\\thebuggenie\\tables\\IssueTypes'), IssueTypes::ID, self::ISSUE_TYPE);
			$crit->addWhere(self::PROJECT_ID, $project_id);
			$crit->addWhere(IssueTypes::ICON, $issuetypes, Criteria::DB_IN);
		...
		public function findIssues($filters = array(), $results_per_page = 30, $offset = 0, $groupby = null, $grouporder = null)
		{
			...
			if (count($filters) > 0)
			{
				$crit->addJoin(TBGIssueCustomFieldsTable::getTable(), TBGIssueCustomFieldsTable::ISSUE_ID, Issues::ID);
			...
			if ($count > 0)
			{
				...
				if ($groupby !== null)
				{
					...
					switch ($groupby)
					{
						...
						case 'edition':
							$crit->addJoin(TBGIssueAffectsEditionTable::getTable(), TBGIssueAffectsEditionTable::ISSUE, self::ID);
							$crit->addJoin($this->_connection->getTable('\\thebuggenie\\tables\\Editions'), Editions::ID, TBGIssueAffectsEditionTable::EDITION, array(), Criteria::DB_LEFT_JOIN, TBGIssueAffectsEditionTable::getTable());
							$crit->addSelectionColumn(Editions::NAME);
							$crit->addOrderBy(Editions::NAME, $grouporder);
							break;
						case 'build':
							$crit->addJoin(TBGIssueAffectsBuildTable::getTable(), TBGIssueAffectsBuildTable::ISSUE, self::ID);
							$crit->addJoin(Builds::getTable(), Builds::ID, TBGIssueAffectsBuildTable::BUILD, array(), Criteria::DB_LEFT_JOIN, TBGIssueAffectsBuildTable::getTable());
							$crit->addSelectionColumn(Builds::NAME);
							$crit->addOrderBy(Builds::NAME, $grouporder);
							break;
						case 'component':
							$crit->addJoin(TBGIssueAffectsComponentTable::getTable(), TBGIssueAffectsComponentTable::ISSUE, self::ID);
							$crit->addJoin(Components::getTable(), Components::ID, TBGIssueAffectsComponentTable::COMPONENT, array(), Criteria::DB_LEFT_JOIN, TBGIssueAffectsComponentTable::getTable());
		...
		{
			$crit = $this->getCriteria();
			$crit->addJoin($this->_connection->getTable('\\thebuggenie\\tables\\Projects'), Projects::ID, self::PROJECT_ID);
