<?php
	...
	class IssueSpentTimes extends ScopedTable
	{
		...
		public function __construct()
		{
			...
			parent::_addForeignKeyColumn(self::EDITED_BY, $this->_connection->getTable('\\thebuggenie\\tables\Users'), Users::ID);
		...
		public function getSpentTimesByDateAndIssueIDs($startdate, $enddate, $issue_ids)
		{
			...
			if (count($issue_ids))
			{
				...
				$crit = $this->getCriteria();
				$crit->addWhere(self::EDITED_AT, $enddate, \b2db\Criteria::DB_LESS_THAN_EQUAL);
				$crit->addJoin($this->_connection->getTable('TBGIssueRelationsTable'), TBGIssueRelationsTable::PARENT_ID, self::ISSUE_ID);
