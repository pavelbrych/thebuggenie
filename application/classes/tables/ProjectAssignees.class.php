<?php
	 ...
	 * @subpackage tables
	 */
	class ProjectAssignees extends ScopedTable 
	{
		...
		public function getProjectsByUserID($user_id)
		{
			...
			if ($res = $this->doSelect($crit))
			{
				while ($row = $res->getNextRow())
				{
					$projects[$row->get(self::PROJECT_ID)] = \caspar\core\Caspar::factory()->manufacture('\\thebuggenie\\entities\\Project', $row->get(self::PROJECT_ID), $row); 
				}
			}
			return $projects;
		}
