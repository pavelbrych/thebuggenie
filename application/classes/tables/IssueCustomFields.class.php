<?php
	...
	class IssueCustomFields extends ScopedTable
	{
		...
		protected function _setup()
		{
			...
			parent::_addForeignKeyColumn(self::CUSTOMFIELDS_ID, $this->_connection->getTable('\\thebuggenie\\tables\\CustomFields'), CustomFields::ID);
		...
		{
			$crit = $this->getCriteria();
//			$crit->addJoin($this->_connection->getTable('TBGCustomFieldOptionsTable'), TBGCustomFieldOptionsTable::ID, self::OPTION_VALUE);
			$crit->addWhere(self::ISSUE_ID, $issue_id);
