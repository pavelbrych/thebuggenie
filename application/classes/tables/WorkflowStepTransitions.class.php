<?php
	...
	class WorkflowStepTransitions extends ScopedTable
	{
		...
		{
			parent::_addForeignKeyColumn(self::WORKFLOW_ID, $this->_connection->getTable('\\thebuggenie\\tables\\Workflows'), Workflows::ID);
			parent::_addForeignKeyColumn(self::FROM_STEP_ID, $this->_connection->getTable('\\thebuggenie\\tables\\WorkflowSteps'), WorkflowSteps::ID);
			parent::_addForeignKeyColumn(self::TRANSITION_ID, $this->_connection->getTable('\\thebuggenie\\tables\\WorkflowTransitions'), WorkflowTransitions::ID);
