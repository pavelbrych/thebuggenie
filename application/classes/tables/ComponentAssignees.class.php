<?php
	 ...
	 * @subpackage tables
	 */
	class ComponentAssignees extends ScopedTable 
	{
		...
		protected function _setup()
		{
			...
			parent::_addForeignKeyColumn(self::COMPONENT_ID, $this->_connection->getTable('\\thebuggenie\\tables\\Components'), Components::ID);
		...
		public function getProjectsByUserID($user_id)
		{
			...
			if ($res = $this->doSelect($crit))
			{
				...
				{
					$projects[$row->get(Components::PROJECT)] = \caspar\core\Caspar::factory()->manufacture('\\thebuggenie\\entities\\Project', $row->get(Components::PROJECT)); 
				}
			}
			return $projects;
		}
