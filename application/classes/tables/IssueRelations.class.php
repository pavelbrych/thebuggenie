<?php
	...
	class IssueRelations extends ScopedTable 
	{
		...
		protected function _setup()
		{
			...
			parent::_addForeignKeyColumn(self::PARENT_ID, $this->_connection->getTable('\\thebuggenie\\tables\\Issues'), Issues::ID);
			parent::_addForeignKeyColumn(self::CHILD_ID, $this->_connection->getTable('\\thebuggenie\\tables\\Issues'), Issues::ID);
		}
