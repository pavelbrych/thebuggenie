<?php
	...
	class WorkflowSteps extends ScopedTable
	{
		...
		protected function _setup()
		{
			...
			parent::_addForeignKeyColumn(self::STATUS_ID, $this->_connection->getTable('\\thebuggenie\\tables\\ListTypes'), ListTypes::ID);
		...
		public function getByWorkflowID($workflow_id)
		{
			...
			if ($res = $this->doSelect($crit))
			{
				...
				{
					$return_array[$row->get(self::ID)] = \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\WorkflowStep', $row->get(self::ID), $row);
				}
			}
