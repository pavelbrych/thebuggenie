	...
	<tr>
		...
		<td valign="top">
			...
			<?php if ($uploads_enabled && $access_level == TBGSettings::ACCESS_FULL): ?>
				<form accept-charset="<?php echo \caspar\core\Caspar::getI18n()->getCharset(); ?>" action="<?php echo make_url('configure_files'); ?>" method="post" onsubmit="TBG.Main.Helpers.formSubmit('<?php echo make_url('configure_files'); ?>', 'config_uploads'); return false;" id="config_uploads">
			<?php endif; ?>
