<?php
	...
	$csp_response->setTitle(__('Configure issue types'));
			...
			<?php if ($mode == 'issuetypes'): ?>
				<div id="tab_types_pane" style="padding-top: 0; width: 750px;">
					...
					<div class="rounded_box yellow borderless" style="margin: 5px 0 0 0; padding: 3px; font-size: 12px;">
						<form accept-charset="<?php echo \caspar\core\Caspar::getI18n()->getCharset(); ?>" action="<?php echo make_url('configure_issuetypes_add'); ?>" onsubmit="TBG.Config.Issuetype.add('<?php echo make_url('configure_issuetypes_add'); ?>');return false;" id="add_issuetype_form">
