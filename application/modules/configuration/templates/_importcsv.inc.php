<div class="backdrop_box large" style="text-align: left;">
	...
	<div id="backdrop_detail_content">
		...
		<form accept-charset="<?php echo \caspar\core\Caspar::getI18n()->getCharset(); ?>" method="post" id="import_csv_form" onsubmit="TBG.Config.Import.importCSV('<?php echo make_url('configure_do_import_csv', array('type' => $type)); ?>');return false;">
