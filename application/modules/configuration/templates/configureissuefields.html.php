...
<td valign="top">
	<div style="width: 750px;" id="config_issuefields">
		...
		<div class="rounded_box yellow borderless" style="margin: 5px 0 0 0; font-size: 12px;">
			...
			<form accept-charset="<?php echo \caspar\core\Caspar::getI18n()->getCharset(); ?>" action="<?php echo make_url('configure_issuefields_add_customtype'); ?>" onsubmit="TBG.Issues.Field.Custom.add('<?php echo make_url('configure_issuefields_add_customtype'); ?>');return false;" id="add_custom_type_form">
...
<script>
	var picker = new ColorPicker({iconPath: '<?php echo TBGSettings::getURLhost() . \caspar\core\Caspar::getTBGPath() . 'themes/' . TBGSettings::getThemeName() . '/cpicker/'; ?>'});
