<?php 
	...
	$csp_response->setTitle(__('Dashboard'));
	$csp_response->addBreadcrumb(__('Personal dashboard'), make_url('dashboard'), tbg_get_breadcrumblinks('main_links'));
...
<?php /*<td id="dashboard_lefthand" class="side_bar">
			<?php \caspar\core\Event::createNew('core', 'dashboard_left_top')->trigger(); ?>
			<div class="container_div" style="margin: 0 0 5px 5px;">
				<?php include_component('main/myfriends'); ?>
			</div>
			<?php \caspar\core\Event::createNew('core', 'dashboard_left_bottom')->trigger();?>
</td> */ ?>
<?php \caspar\core\Event::createNew('core', 'dashboard_main_top')->trigger(); ?>
<?php if (!count($views)): ?>
...
<?php endif; ?>
<?php \caspar\core\Event::createNew('core', 'dashboard_main_bottom')->trigger(); ?>
