<div class="container_div menu_links" id="<?php echo $target_type; ?>_<?php echo $target_id; ?>_container" style="margin: 0 0 5px 5px;">
	<div class="header">
		<?php if ($csp_user->canEditMainMenu() && ((\thebuggenie\core\Context::isProjectContext() && !\thebuggenie\core\Context::getCurrentProject()->isArchived()) || !\thebuggenie\core\Context::isProjectContext())): ?>
