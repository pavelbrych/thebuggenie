...
<?php else: ?>
	...
	<a href="javascript:void(0);" onclick="$('team_<?php echo $team->getID() . "_" . $rnd_no; ?>').toggle();" style="font-weight: normal;"<?php if ($csp_user->isMemberOfTeam($team)): ?> class="friend" title="<?php echo __('You are a member of this team'); ?>"<?php endif; ?>><?php echo $team->getName(); ?></a>
	<div id="team_<?php echo $team->getID() . '_' . $rnd_no; ?>" style="z-index: 100; width: 300px; display: none; position: absolute;" class="rounded_box white shadowed user_popup dropdown_box">
		<div style="padding: 3px;">
			...
			<div class="user_realname">
				...
				<?php if ($csp_user->isMemberOfTeam($team)): ?>
			...
			<div style="clear: both;">
				...
				<?php endif; ?>
				<?php \caspar\core\Event::createNew('core', 'teamactions_bottom', $team)->trigger(); ?>
			</div>
		</div>
