<?php
	...
	{
			echo link_tag(make_url('vcs_commitspage', array('project_key' => TBGContext::getCurrentProject()->getKey())), __('Commits'), (($csp_response->getPage() == 'vcs_commitspage') ? array('class' => 'selected') : array()));
