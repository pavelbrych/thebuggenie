<?php
	...
	$csp_response->addBreadcrumb(__('Commits'), null, tbg_get_breadcrumblinks('project_summary', $selected_project));
	$csp_response->setTitle(__('"%project_name%" commits', array('%project_name%' => $selected_project->getName())));
