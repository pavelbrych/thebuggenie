<?php
	 ...
	 * @subpackage vcs_integration
	 */
	class TBGVCSIntegrationCommitsTable extends ScopedTable 
	{
		...
		protected function _setup()
		{
			...
			parent::_addForeignKeyColumn(self::PROJECT_ID, \caspar\core\Caspar::getB2DBInstance()->getTable('\\thebuggenie\\tables\\Projects'), \thebuggenie\tables\Projects::ID);
		}
