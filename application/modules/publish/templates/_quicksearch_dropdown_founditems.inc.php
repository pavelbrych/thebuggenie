...
<?php if ($resultcount > 0): ?>
	...
	<?php if (true || $resultcount - $cc > 0): ?>
		<li class="find_more_issues last">
			...
			<div class="hidden url"><?php echo (\thebuggenie\core\Context::isProjectContext()) ? make_url('publish_find_project_articles', array('project_key' => \thebuggenie\core\Context::getCurrentProject()->getKey())) : make_url('publish_find_articles'); ?>?articlename=<?php echo $searchterm; ?></div>
		</li>
	<?php endif; ?>
<?php else: ?>
