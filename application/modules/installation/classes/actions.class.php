<?php
	...
	class installationActions extends TBGAction
	{
		 ...
		 * @return null
		 */
		public function runInstallIntro(Request $request)
		{
			$this->getResponse()->setDecoration(TBGResponse::DECORATE_NONE);
		 ...
		 * @return null
		 */
		public function runInstallStep1(Request $request)
		{
			$this->all_well = true;
		 ...
		 * @return null
		 */
		public function runInstallStep2(Request $request)
		{
		 ...
		 * @return null
		 */
		public function runInstallStep3(Request $request)
		{
		 ...
		 * @return null
		 */
		public function runInstallStep4(Request $request)
		{
			try
			{
		 ...
		 * @return null
		 */
		public function runInstallStep5(Request $request)
		{
		 ...
		 * @return null
		 */
		public function runInstallStep6(Request $request)
		{
