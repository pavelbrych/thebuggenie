<?php
	...
	class projectActions extends TBGAction
	{
		...
		public function runDashboard(Request $request)
		{
			...
			$this->dashboardViews = TBGDashboardView::getViews($this->selected_project->getID(), TBGDashboardView::TYPE_PROJECT);
		}
		 ...
		 * @param TBGRequest $request
		 */
		public function runFiles(Request $request)
		{
		}
		 ...
		 * @param TBGRequest $request
		 */
		public function runRoadmap(Request $request)
		{
		 ...
		 * @param TBGRequest $request
		 */
		public function runTimeline(Request $request)
		{
...
//			$this->unassigned_issues = $this->selected_project->getIssuesWithoutMilestone();
		 ...
		 * @param TBGRequest $request
		 */
		public function runScrumShowDetails(Request $request)
		{
			...
			{
				$selected_sprint = \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\Milestone', $s_id);
			}
			else
			{
		 ...
		 * @param TBGRequest $request
		 */
		public function runScrumShowBurndownImage(Request $request)
		{
			$this->forward403unless($this->_checkProjectPageAccess('project_scrum'));
			...
			{
				$milestone = \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\Milestone', $m_id);
			}
			else
			{
		...
		public function runScrumAssignStory(Request $request)
		{
			...
			try
			{
				...
				try
				{
					$sprint = \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\Milestone', $new_sprint_id);
				}
				catch (Exception $e) {}
				if ($issue instanceof TBGIssue)
				{
		 ...
		 * @param TBGRequest $request
		 */
		public function runTeam(Request $request)
		{
		...
		public function runStatisticsLast15(Request $request)
		{
			$this->forward403unless($this->_checkProjectPageAccess('project_statistics'));
		...
		public function runStatisticsImagesets(Request $request)
		{
			$this->forward403unless($this->_checkProjectPageAccess('project_statistics'));
			$success = false;
					...
					if ($item_id != 0 || $this->key == 'issues_per_state')
					{
						switch ($this->key)
						{
							case 'issues_per_status':
								$item = \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\Status', $item_id);
								break;
							case 'issues_per_priority':
								$item = \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\Priority', $item_id);
								break;
							case 'issues_per_category':
								$item = \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\Category', $item_id);
								break;
							case 'issues_per_resolution':
								$item = \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\Resolution', $item_id);
								break;
							case 'issues_per_reproducability':
								$item = \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\Reproducability', $item_id);
								break;
		...
		public function runStatisticsGetImage(Request $request)
		{
			$this->forward403unless($this->_checkProjectPageAccess('project_statistics'));
		...
		public function runListIssuefields(Request $request)
		{
			try
			{
		...
		public function runGetMilestoneIssues(Request $request)
		{
			try
			{
				$i18n = \caspar\core\Caspar::getI18n();
		...
		public function runGetMilestoneDetails(Request $request)
		{
			try
			{
				$i18n = \caspar\core\Caspar::getI18n();
		...
		public function runGetMilestone(Request $request)
		{
		...
		public function runRemoveMilestone(Request $request)
		{
			$milestone = new TBGMilestone($request['milestone_id']);
		...
		public function runMenuLinks(Request $request)
		{
		}

		public function runTransitionIssue(Request $request)
		{
			try
			{
				$transition = \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\WorkflowTransition', $request->getParameter('transition_id'));
		...
		public function runTransitionIssues(Request $request)
		{
			try
			{
				$transition = \caspar\core\Caspar::factory()->manufacture('\thebuggenie\entities\WorkflowTransition', $request->getParameter('transition_id'));
		...
		public function runReleases(Request $request)
		{
			$this->_setupBuilds();
		}
