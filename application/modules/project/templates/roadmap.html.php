<?php
	...
	$csp_response->addBreadcrumb(__('Roadmap'), null, tbg_get_breadcrumblinks('project_summary', $selected_project));
	$csp_response->setTitle(__('"%project_name%" roadmap', array('%project_name%' => $selected_project->getName())));
