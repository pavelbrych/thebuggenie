...
<?php if (array_key_exists('target_type', $activity) && $activity['target_type'] == 1 && ($issue = \caspar\core\Caspar::factory()->TBGIssue($activity['target'])) && $issue instanceof TBGIssue): ?>
