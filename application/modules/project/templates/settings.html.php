<?php
	...
	$csp_response->addBreadcrumb(__('Project settings'), null, tbg_get_breadcrumblinks('project_settings', $selected_project));
	$csp_response->setTitle(__('"%project_name%" settings', array('%project_name%' => $selected_project->getName())));
